...
describe("binary", () => {
  ...
  it("should detect platform Darwin x32", () => {
    ...
    expect(Binary).toHaveBeenCalledWith(
      expect.stringMatching(/.*darwin-386.tar.gz$/),
      expect.anything()
    );
  ...
  it("should detect platform Darwin x64", () => {
    ...
    install();
    expect(Binary).toHaveBeenCalledWith(
      expect.stringMatching(/.*darwin-amd64.tar.gz$/),
      expect.anything()
    );
    expect(mockInstall).toHaveBeenCalled();
  });
  ...
  it("should detect platform Linux x32", () => {
    ...
    install();
    expect(Binary).toHaveBeenCalledWith(
      expect.stringMatching(/.*linux-386.tar.gz$/),
      expect.anything()
    );
    expect(mockInstall).toHaveBeenCalled();
  });
  ...
  it("should detect platform Linux x64", () => {
    ...
    install();
    expect(Binary).toHaveBeenCalledWith(
      expect.stringMatching(/.*linux-amd64.tar.gz$/),
      expect.anything()
    );
    expect(mockInstall).toHaveBeenCalled();
  });
  ...
  it("should detect platform Windows x32", () => {
    ...
    install();
    expect(Binary).toHaveBeenCalledWith(
      expect.stringMatching(/.*windows-386.tar.gz$/),
      expect.anything()
    );
    expect(mockInstall).toHaveBeenCalled();
  });
  ...
  it("should detect platform Windows x32", () => {
    ...
    install();
    expect(Binary).toHaveBeenCalledWith(
      expect.stringMatching(/.*windows-amd64.tar.gz$/),
      expect.anything()
    );
    expect(mockInstall).toHaveBeenCalled();
  });
